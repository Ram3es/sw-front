...
const mockData: IOffersCard[] = [
  {
    appid: ESteamAppId.CSGO,
    imageUrl: 'url1',
    inventoryItemId: 'ite11111m1',
    price: { currency: 'USD', amount: 10 },
    steamPrice: { currency: 'USD', amount: 9 },
    wearFloat: 0.5,
    rarity: 'Common',
    typeName: 'Type1',
    name: 'Item1'
  },
  {
    appid: ESteamAppId.CSGO,
    imageUrl: 'url2',
    inventoryItemId: 'Other | 111Bushi Zhe Hunting Blablablaa',
    price: { currency: 'USD', amount: 152144 },
    steamPrice: { currency: 'USD', amount: 9 },
    wearFloat: 0.6,
    rarity: 'Uncommon',
    typeName: 'Type2',
    name: 'Other | Bushi Zhe Hunting Blablablaa'
  },
  {
    appid: ESteamAppId.CSGO,
    imageUrl: 'url1',
  ...
  },
  {
    appid: ESteamAppId.CSGO,
    imageUrl: 'url2',
    inventoryItemId: 'Other | Bushi Zhe1111 Hunting Blablablaa',
    price: { currency: 'USD', amount: 152144 },
    steamPrice: { currency: 'USD', amount: 9 },
    wearFloat: 0.6,
    rarity: 'Uncommon',
  ...
  },
  {
    appid: ESteamAppId.CSGO,
    imageUrl: 'url2',
    inventoryItemId: 'Other | Bushi Zhe H1unting Blablablaa',
    price: { currency: 'USD', amount: 152144 },
    steamPrice: { currency: 'USD', amount: 9 },
    wearFloat: 0.6,
    rarity: 'Uncommon',
  ...
  },
  {
    appid: ESteamAppId.CSGO,
    imageUrl: 'url2',
    inventoryItemId: 'Other | 4Bushi Zhe11 Hunting Blablablaa',
    price: { currency: 'USD', amount: 152144 },
    steamPrice: { currency: 'USD', amount: 9 },
    wearFloat: 0.6,
    rarity: 'Uncommon',
      ...
      <div className="w-full flex flex-grow gap-8 justify-center pt-6 sm:py-12">
        <div className="w-full h-full max-w-[672px] pb-10 px-6 sm:px-0 text-white overflow-y-scroll relative flex flex-col gap-4">
          ...
          <div className="grid grid-cols-[24px_1fr] gap-3">
            <Checkbox
              activeClass={check ? 'text-swViolet bg-white border-white' : 'bg-transparent border-graySecondary'}
          ...
          <div className="grid grid-cols-[24px_1fr] gap-3">
            ...
            <div className="flex flex-col gap-5 justify-end font-normal text-sm">
              ...
              <p>
                I agree to the beggining of the contract execution before the end of the cancellation period. I am aware
                that I thereby lose my right of cancellation.
              </p>
            </div>
          </div>
        </div>
