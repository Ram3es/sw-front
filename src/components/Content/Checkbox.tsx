...
const Checkbox: React.FC<CheckboxProps> = ({ checked, onChange }) => {
  ...
  return (
    ...
    checked ? "bg-white border-white" : "border-graySecondary")}>
      <input
