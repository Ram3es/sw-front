const MarketShieldMarkIcon = () => {
  return (
    <svg role="img" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512" aria-hidden="true" >
...
export default MarketShieldMarkIcon;