    ...
    <div className="fixed left-0 bottom-0 w-full p-6 flex gap-12 font-['Barlow'] items-center bg-graySecondary text-darkSecondary">
      ...
      <div className={classNames(
        ...
        <Button
            ...
            heightClass="h-10"
            className='justify-center relative uppercase text-darkSecondary font-semibold border border-darkSecondary cta-clip-path '
        >
        ...
        <Button
            ...
            heightClass="h-10"
            className='justify-center uppercase bg-darkSecondary text-white font-semibold border border-darkSecondary cta-clip-path '
        />
      </div>
    </div>
  )
